    ...
    >
      {composeRenderProps(children, (children, { isSelected }) => (
        <>
          {isSelected && (
            <IconCheck
              className="-mx-1 mr-1.5 col-start-1 row-start-1 not-has-[[slot=description]]:self-center has-[[slot=description]]:mt-[1.5px]"
              data-slot="check-indicator"
            />
          )}
          <div className="col-start-2 col-span-3 w-full">
